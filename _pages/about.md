...
[PDF](files/papers/tacl-2025-keft.pdf)
...
[PDF](files/papers/information-sciences-2024-lnet.pdf)
...
| Additional selected paper | Venue | Rankings | Link |
| --- | --- | --- | --- |
| Policy-based Broadcast Access Authorization for Flexible Data Sharing in Clouds | IEEE TDSC, 2021 | CCF-A · JCR Q1 | [PDF](files/papers/tdsc-2021-pbaa.pdf) |
| A Heterogeneous Feature Ensemble Learning based Deepfake Detection Method | IEEE ICC, 2022 | CCF-C | [PDF](files/papers/icc-2022-deepfake-detection.pdf) |
| A Feature-Hybrid Malware Variants Detection Using CNN Based Opcode Embedding and BPNN Based API Embedding | Computers & Security, 2019 | CCF-B | [PDF](files/papers/computers-security-2019-feature-hybrid-malware.pdf) |
| CP-ABSE: A Ciphertext-Policy Attribute-Based Searchable Encryption Scheme | IEEE Access, 2019 | | [PDF](files/papers/ieee-access-2019-cp-abse.pdf) |
| Sensitive System Calls Based Packed Malware Variants Detection Using Principal Component Initialized MultiLayers Neural Networks | Cybersecurity, 2018 | CCF-B · JCR Q1 | [PDF](files/papers/cybersecurity-2018-packed-malware-detection.pdf) |
| IRMD: Malware Variant Detection Using Opcode Image Recognition | ICPADS, 2016 | CCF-C | [PDF](files/papers/icpads-2016-irmd.pdf) |
...
| Title | Inventors | Patent No. | Publication No. | Granted |
| --- | --- | --- | --- | --- |
| 恶意代码语义分析模型的生成方法、装置及存储介质 | 张吉昕; 方思鑫 | ZL 2025 1 1375386.9 | CN 120874051 B | 2025-12-02 |
| 基于多模态数据的风险摘要生成方法 | 张吉昕; 程轲; 叶志伟; 岳鼎锋; 宋政 | ZL 2025 1 0044043.8 | CN 120105325 B | 2026-04-17 |
...
| Software | Owners | Registration No. | Registered |
| --- | --- | --- | --- |
| 多层PCB全自动布线系统 [PCBRouter] V1.0 | 张吉昕; 李海云 | 2025SR0841952 | 2025-05-22 |
| 恶意代码智能检测系统 [MalDetect] V1.0 | 张吉昕 | 2024SR0518674 | 2024-04-17 |
| 大模型渗透测试系统 V1.0 | 张吉昕; 盛烁; 程轲; 李海云; 宋政 | 2026SR0441318 | 2026-03-16 |
| AgentFix-自动化代码漏洞定位与修复系统 V1.0 | 张吉昕; 李海云; 盛烁; 程轲; 宋政 | 2026SR0441698 | 2026-03-16 |
| 整合多源异构数据的大模型综合问答系统 V1.0 | 湖北工业大学 | 2025SR2488197 | 2025-12-25 |
